...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tabPage2->Text = L"Матрица смежности графа Кёнига";
			...
			this->Name = L"Form1";
			this->Text = L"Матрицы электроцепей и графа Кёнига";
...
#pragma endregion
	...
	private: void calculateMatrixes() {
		...
		incidence_matrix_->buildiKoenigAdjacencyMatFromContactList( contact_list_ );
	}
